...
export class CreatedOrderModal extends BaseModal {
  ...
  constructor(page: Page) {
    super(page)
    this.orderCreatedButton = new Button(page, '[data-name="orderSuccessfullyCreated-popup-ok-button"]')
    this.createdOrderText = page.locator('h3.notification-popup__text')
    this.trackingCodeText = page.locator('.notification-popup__text', { hasText: /Tracking code: \d{4}$/ })
  }
